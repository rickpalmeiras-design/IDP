...
def figuras():
    ...
    ax.set_xlabel('Efeito de AIOE x pos (pontos percentuais por desvio-padrao)')
...
AIOE é padronizado entre ocupações (desvio-padrão {escala.iloc[0].desvio_padrao:.3f}), então um ponto
