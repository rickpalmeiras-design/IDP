WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2023 AND 2024 AND ano*4+trimestre-1 BETWEEN 8094 AND 8095
    ), pares AS (
      ...
      FROM base a LEFT JOIN base b ON b.t=a.t+1 AND b.id_upa=a.id_upa
        ...
        AND a.ano_nascimento BETWEEN 1900 AND 2023
        AND b.ano_nascimento BETWEEN 1900 AND 2024
        AND ABS(a.ano_nascimento-b.ano_nascimento)<=1 AND b.idade BETWEEN a.idade AND a.idade+1
      WHERE a.t=8094 AND a.v1016<5 AND a.ocupado
