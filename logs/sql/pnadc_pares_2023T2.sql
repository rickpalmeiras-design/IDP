WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2023 AND 2024 AND ano*4+trimestre-1 BETWEEN 8093 AND 8094
    ), pares AS (
      ...
      WHERE a.t=8093 AND a.v1016<5 AND a.ocupado
