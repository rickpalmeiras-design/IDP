WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2019 AND 2020 AND ano*4+trimestre-1 BETWEEN 8079 AND 8080
    ), pares AS (
      ...
      WHERE a.t=8079 AND a.v1016<5 AND a.ocupado
