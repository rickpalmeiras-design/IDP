WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2020 AND 2021 AND ano*4+trimestre-1 BETWEEN 8080 AND 8081
    ), pares AS (
      ...
      WHERE a.t=8080 AND a.v1016<5 AND a.ocupado
