WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2024 AND 2025 AND ano*4+trimestre-1 BETWEEN 8097 AND 8098
    ), pares AS (
      ...
      WHERE a.t=8097 AND a.v1016<5 AND a.ocupado
