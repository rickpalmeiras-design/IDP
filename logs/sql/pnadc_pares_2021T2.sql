WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2021 AND 2022 AND ano*4+trimestre-1 BETWEEN 8085 AND 8086
    ), pares AS (
      ...
      WHERE a.t=8085 AND a.v1016<5 AND a.ocupado
