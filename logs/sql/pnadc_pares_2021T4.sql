WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2021 AND 2022 AND ano*4+trimestre-1 BETWEEN 8087 AND 8088
    ), pares AS (
      ...
      WHERE a.t=8087 AND a.v1016<5 AND a.ocupado
