WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2022 AND 2023 AND ano*4+trimestre-1 BETWEEN 8091 AND 8092
    ), pares AS (
      ...
      WHERE a.t=8091 AND a.v1016<5 AND a.ocupado
