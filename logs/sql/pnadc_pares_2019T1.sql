WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2019 AND 2020 AND ano*4+trimestre-1 BETWEEN 8076 AND 8077
    ), pares AS (
      ...
      WHERE a.t=8076 AND a.v1016<5 AND a.ocupado
