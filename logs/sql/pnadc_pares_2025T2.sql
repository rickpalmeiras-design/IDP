WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2025 AND 2026 AND ano*4+trimestre-1 BETWEEN 8101 AND 8102
    ), pares AS (
      ...
      WHERE a.t=8101 AND a.v1016<5 AND a.ocupado
