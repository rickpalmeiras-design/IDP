WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2025 AND 2026 AND ano*4+trimestre-1 BETWEEN 8100 AND 8101
    ), pares AS (
      ...
      FROM base a LEFT JOIN base b ON b.t=a.t+1 AND b.id_upa=a.id_upa
        ...
        AND a.ano_nascimento BETWEEN 1900 AND 2025
        AND b.ano_nascimento BETWEEN 1900 AND 2026
        AND ABS(a.ano_nascimento-b.ano_nascimento)<=1 AND b.idade BETWEEN a.idade AND a.idade+1
      WHERE a.t=8100 AND a.v1016<5 AND a.ocupado
