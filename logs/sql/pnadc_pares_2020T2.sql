WITH base AS (
      ...
      FROM `basedosdados.br_ibge_pnadc.microdados` WHERE ano BETWEEN 2020 AND 2021 AND ano*4+trimestre-1 BETWEEN 8081 AND 8082
    ), pares AS (
      ...
      FROM base a LEFT JOIN base b ON b.t=a.t+1 AND b.id_upa=a.id_upa
        ...
        AND a.ano_nascimento BETWEEN 1900 AND 2020
        AND b.ano_nascimento BETWEEN 1900 AND 2021
        AND ABS(a.ano_nascimento-b.ano_nascimento)<=1 AND b.idade BETWEEN a.idade AND a.idade+1
      WHERE a.t=8081 AND a.v1016<5 AND a.ocupado
