...
from src.robustez import stage07

# A 07 fica fora do padrão (--fim 06): robustez é revisão, não alimenta a dissertação.
FUNCOES = {'00': stage00, '01': stage01, '02': stage02, '03': stage03,
           '04': stage04, '05': stage05, '06': stage06, '07': stage07}
