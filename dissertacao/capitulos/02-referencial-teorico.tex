...
leem os coeficientes estimados no Capítulo~\ref{sec:resultados}, expressos por
desvio-padrão de exposição. Por fim, exposição elevada não deve ser tomada como
